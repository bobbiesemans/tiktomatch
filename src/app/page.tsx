...
import { PlatformMockup } from "@/components/home/platform-mockup"
import {
          ...
          <div>
            ...
            <HeroText>
              <p className="text-lg text-white/55 max-w-lg mb-6 leading-relaxed">
                ...
                TikToMatch is het eerste Belgische platform gespecialiseerd in TikTok Shop — AI-matching op echte verkoopdata, enkel betalen bij resultaat.
              </p>
            </HeroText>
